...
class JobTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create job_type" do
    assert_difference('JobType.count') do
      post job_types_url, params: { job_type: { task: @job_type.task, template: @job_type.template } }
    end
  ...
  test "should update job_type" do
    patch job_type_url(@job_type), params: { job_type: { task: @job_type.task, template: @job_type.template } }
