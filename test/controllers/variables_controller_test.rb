...
class VariablesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create variable" do
    assert_difference('Variable.count') do
      post variables_url, params: { variable: { name: @variable.name, value: @variable.value } }
    end
  ...
  test "should update variable" do
    patch variable_url(@variable), params: { variable: { name: @variable.name, value: @variable.value } }
